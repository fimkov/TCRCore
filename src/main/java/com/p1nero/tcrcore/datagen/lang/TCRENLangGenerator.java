...
public class TCRENLangGenerator extends TCRLangProvider {
    ...
    protected void addTranslations() {
        ...
        this.addQuest(TCRQuests.GET_NETHER_MONOLITH_KEY_1, "Nether Chapter", "Craft [%s], obtain [%s]", "As the ancient inscription on the resonance stone says, to activate [%s], you need to obtain [%s]. One of them is scattered in [%s]. Hint: Craft [%s] to summon the guardian of [%s] - [%s], and take back [%s]!");
